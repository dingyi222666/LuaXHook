...
base.findAndHookFuction = function(targetFunction,targetTable,isNeedSelf)
...
function base.replaceFunction(targetField,targetFunction)
...
base.init = function(option,api)
  --挂载辅助函数到自己的表去

  base.utils = api.utils
  local addToApiFunction = {"findAndHookFuction", "hookFunction" }
